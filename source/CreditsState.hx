...
class CreditsState extends MusicBeatState
{
	...
	private static var creditsStuff:Array<Dynamic> = [ //Name - Icon name - Description - Link - BG Color
		['Vs Toffee Team'],
		['ToffeeRecord',        'toffee',           'Literally Everything lmao',                        'https://www.youtube.com/channel/UCkpiVBLIBvsb1ZKlPUEfRIQ', 0xFF8b0000],
		[''],
		['Mod Contributors'],
		['Bam',                 'bam',              'Cola Note Idea',                                   'https://twitter.com/baldi_le',         0xFF8b8b8b],
		[''],
		['Psych Engine Team'],
